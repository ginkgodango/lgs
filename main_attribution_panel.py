...
jpm_main_returns_filepath = 'U:/CIO/#Data/input/jpm/performance/2020/12/Historical Time Series - Monthly - Main Returns.xlsx'
jpm_alts_returns_filepath = 'U:/CIO/#Data/input/jpm/performance/2020/12/Historical Time Series - Monthly - Alts Returns.xlsx'
jpm_main_benchmarks_filepath = 'U:/CIO/#Data/input/jpm/performance/2020/12/Historical Time Series - Monthly - Main Benchmarks.xlsx'
jpm_alts_benchmarks_filepath = 'U:/CIO/#Data/input/jpm/performance/2020/12/Historical Time Series - Monthly - Alts Benchmarks.xlsx'
jpm_main_mv_filepath = 'U:/CIO/#Data/input/jpm/performance/2020/12/Historical Time Series - Monthly - Main Market Values.xlsx'
jpm_alts_mv_filepath = 'U:/CIO/#Data/input/jpm/performance/2020/12/Historical Time Series - Monthly - Alts Market Values.xlsx'
jpm_strategy_returns_benchmarks_mv_filepath = 'U:/CIO/#Data/input/jpm/performance/2020/12/Historical Time Series - Monthly - Strategy Market Values Returns and Benchmarks.xlsx'
lgs_returns_benchmarks_filepath = 'U:/CIO/#Data/input/lgs/returns/returns_2020-12-31.csv'
lgs_dictionary_filepath = 'U:/CIO/#Data/input/lgs/dictionary/2020/12/New Dictionary_v17.xlsx'
lgs_allocations_filepath ='U:/CIO/#Data/input/lgs/allocations/asset_allocations_2020-11-30.csv'

output_directory = 'U:/CIO/#Data/output/attribution/tables/'

FYTD = 6
report_date = dt.datetime(2020, 12, 31)
# END USER INPUT DATA
