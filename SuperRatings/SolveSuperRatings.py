...
if __name__ == '__main__':
    ...
    df_0 = pd.read_csv(folderPath + 'SuperRatings-FCRS-202106.csv', parse_dates=['Date'])

    df_1 = pd.read_csv(folderPath + 'SuperRatings-FCRS-202106.csv', parse_dates=['Date'])[['Option Name', 'Product Type', 'Date', 'SR Index', 'Rolling 3 Year %']]

    df_2 = pd.read_csv(folderPath + 'SuperRatings-FCRS-201906.csv', parse_dates=['Date'])[['Option Name', 'Product Type', 'Date', 'SR Index', 'Rolling 1 Year %']]
